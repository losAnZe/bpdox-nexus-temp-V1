...
function Calendar({
  ...
  return (
    <DayPicker
      ...
      className={cn(
        // FIXED: Changed [--cell-size:--spacing(8)] to [--cell-size:theme(spacing.8)]
      ...
      classNames={{
        ...
        month_caption: cn(
          // FIX: Corrected h and px syntax to apply padding and height
          "flex items-center justify-center h-[var(--cell-size)] w-full px-[var(--cell-size)]",
          defaultClassNames.month_caption
        ),
        dropdowns: cn(
          // FIX: Corrected h syntax
